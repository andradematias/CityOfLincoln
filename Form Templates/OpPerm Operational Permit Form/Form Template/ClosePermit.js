...
var CallServerSide = function () {
    ...
    var requestObject = $.ajax({
        type: "POST",
        url: VV.BaseAppUrl + 'api/v1/' + VV.CustomerAlias + '/' + VV.CustomerDatabaseAlias + '/scripts?name=OpPermOperaionalPermitCloseCertificate',
    ...
    if (typeof (resp.status) != 'undefined') {
        ...
        if (resp.data[0] != undefined) {
            if (resp.data[0] == 'Success') {
                VV.Form.Global.SetFieldUpdate('Status', 'Closed');
