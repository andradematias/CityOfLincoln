// SetProfileID for Contact Record
...
var CallServerSide = function () {
    ...
    var requestObject = $.ajax({
        type: "POST",
        url: VV.BaseAppUrl + 'api/v1/' + VV.CustomerAlias + '/' + VV.CustomerDatabaseAlias + '/scripts?name=LibSetProfileID',
    ...
    if (typeof (resp.status) != 'undefined') {
        ...
        if (resp.data[0] != undefined) {
            if (resp.data[0] == 'Success') {
                VV.Form.SetFieldValue('Profile ID', resp.data[2]);
            }
